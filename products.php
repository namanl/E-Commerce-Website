        ...
        <form id="edit-product-form" enctype="multipart/form-data">
		  ...
		  <?php
						if($_GET['submit']){
							...
							$product_name= $_GET['e_product_name'];
							$brand_id= $_GET['e_brand_id'];
							$category_id= $_GET['e_category_id'];
							$product_desc= $_GET['e_product_desc'];
							$product_qty= $_GET['e_product_qty'];
							$product_price= $_GET['e_product_price'];
							
						

						if($product_name != "" && $brand_id != "" && $category_id != "" && $product_desc != "" && $product_qty != "" && $product_price != ""){


								$query= "INSERT INTO products values (DEFAULT,'$product_name','$brand_id','$category_id','$product_desc','$product_qty','$product_price')";
